...
. After clicking the link in the previous step, you may be prompted to *Log in with OpenShift*. Enter the username `admin` and password `{ocp_cluster_openshift_cluster_admin_password}` if prompted.
