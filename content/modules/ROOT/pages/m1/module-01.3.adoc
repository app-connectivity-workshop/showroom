...
----
curl -s https://raw.githubusercontent.com/app-connectivity-workshop/scripts/refs/heads/main/m1/convert_grant_token.sh \
    | bash > summit_token.yaml
----
...
[source,sh,role="execute",subs=attributes+]
----
scp summit_token.yaml \
    lab-user@{rhel_hostname}:/home/lab-user/.local/share/skupper/namespaces/default/input/resources/
----
